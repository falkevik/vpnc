/* Algorithm support checks
   ...
   $Id: supp.c 416 2009-08-19 19:02:00Z Joerg Mayer $
*/
...
const supported_algo_t supp_crypt[] = {
	...
	{"aes128gcm", GCRY_CIPHER_AES128, IKE_ENC_AES_CBC, ISAKMP_IPSEC_ESP_AES_GCM_16, 128},
	{"aes192gcm", GCRY_CIPHER_AES192, IKE_ENC_AES_CBC, ISAKMP_IPSEC_ESP_AES_GCM_16, 192},
	{"aes256gcm", GCRY_CIPHER_AES256, IKE_ENC_AES_CBC, ISAKMP_IPSEC_ESP_AES_GCM_16, 256},
#endif
	{NULL, 0, 0, 0, 0}
};
