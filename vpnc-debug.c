...
const struct debug_strings isakmp_ipsec_esp_enum_array[] = {
	...
	{ ISAKMP_IPSEC_ESP_AES_GCM_8,	" (ISAKMP_IPSEC_ESP_AES_GCM_8)" },
	{ ISAKMP_IPSEC_ESP_AES_GCM_12,	" (ISAKMP_IPSEC_ESP_AES_GCM_12)" },
	{ ISAKMP_IPSEC_ESP_AES_GCM_16,	" (ISAKMP_IPSEC_ESP_AES_GCM_16)" },
...
const struct debug_strings isakmp_modecfg_attrib_enum_array[] = {
	...
	{ ISAKMP_MODECFG_ATTRIB_CISCO_UNKNOWN_0X0015,	" (ISAKMP_MODECFG_ATTRIB_CISCO_UNKNOWN_0X0015)" },
